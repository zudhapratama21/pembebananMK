                        ...
                        <tbody>
                          <tr v-for="(semesters,index) in semester" :key="index">                           
                            ...
                            <td>                              
                              ...
                              <router-link :to="{ name: 'pembebananD3.listSemester.pembenanan', params:{ id_semester:semesters.SEMESTER , id_jurusan : id_jurusan,id_kelas:semesters.KELAS , id_prodi : id_prodi }} " >
