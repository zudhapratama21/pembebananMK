                      ...
                      <table class="table table-striped text-left" id="table-2">
                        ...
                        <tbody>
                          <tr v-for="(semesters,index) in semester" :key="index">                           
                            ...
                            <td>
                              <router-link :to="{name: 'matakuliah.listmatakuliah', params:{ id_semester:semesters.SEMESTER , id_jurusan : id_jurusan , kelas:semesters.KELAS , id_prodi : id_prodi , id_angkatan : id_angkatan }} " >
                                  <span class="btn btn-primary btn-sm">List Mata Kuliah</span>
                              </router-link>
                            </td>
                          </tr>                          
                        </tbody>
