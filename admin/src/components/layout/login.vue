        ...
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Your Company. Made with 💙 Zudha Ganteng
              <div class="mt-2">
          ...
          data-background="assets/img/pens.jpg">
            <div class="absolute-bottom-left index-2">
              <div class="text-light p-5 pb-2">
                <div class="mb-5 pb-3">
                  <!-- <h1 class="mb-2 display-4 font-weight-bold">Good Morning</h1> -->
                  <h5 class="font-weight-normal text-muted-transparent">Politeknik Elektronika Negeri Surabaya , Indonesia</h5>
                </div>
